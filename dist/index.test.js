...
describe('Room Tests', () => {
    ...
    test("occupancyPercentage tiene que devolver 100 si todas las fechas pasadas al metodo están dentro del rango de bookings", () => {
        ...
        const booking3 = new Booking("booking 3", "bok2@bok.es", "2023-10-01", "2023-10-31", 10, room);
    ...
    test("totalOccupancyPercentage tiene que devolver 50 si las fechas pasadas al metodo ocupan el 50% del rango", () => {
        ...
        const booking1 = new Booking("booking 1", "bok@bok.es", "2023-09-01", "2023-09-06", 10, roomA);
        const booking2 = new Booking("booking 2", "bok2@bok.es", "2023-09-07", "2023-09-15", 10, roomA);
        const bookingsA = [booking1, booking2];
        const roomB = new Room('roomB', [], 150, 10);
        const booking3 = new Booking("booking 3", "bok@bok.es", "2023-09-16", "2023-09-22", 10, roomB);
        const booking4 = new Booking("booking 4", "bok2@bok.es", "2023-09-23", "2023-09-30", 10, roomB);
        ...
        const percentage = Room.totalOccupancyPercentage(roomArray, "2023-09-01", "2023-09-30");
    ...
    test("totalOccupancyPercentage tiene que devolver 100 si las fechas pasadas al metodo ocupan el 100% del rango", () => {
        ...
        const bookingsA = [booking1, booking2];
        const roomB = new Room('roomB', [], 150, 10);
        const booking3 = new Booking("booking 3", "bok@bok.es", "2023-09-01", "2023-09-06", 10, roomB);
        const booking4 = new Booking("booking 4", "bok2@bok.es", "2023-09-07", "2023-09-15", 10, roomB);
        const bookingsB = [booking3, booking4];
        const room1 = new Room(roomA.name, bookingsA, roomA.rate, roomA.discount);
        const room2 = new Room(roomB.name, bookingsB, roomB.rate, roomB.discount);
        const roomArray = [room1, room2];
        const percentage = Room.totalOccupancyPercentage(roomArray, "2023-09-01", "2023-09-15");
        expect(percentage).toBe(100);
    });
    test("totalOccupancyPercentage tiene que devolver 0 si las fechas pasadas al metodo están fuera del rango", () => {
        ...
        const room2 = new Room(roomB.name, bookingsB, roomB.rate, roomB.discount);
        const roomArray = [room1, room2];
        const percentage = Room.totalOccupancyPercentage(roomArray, "2023-10-01", "2023-10-15");
    ...
    test('availableRooms tiene que devolver una room', () => {
        ...
        const booking1 = new Booking("booking1", "bok@bok.es", "2023-10-16", "2023-10-31", 10, room1);
        const booking2 = new Booking("booking2", "bok2@bok.es", "2023-09-07", "2023-09-15", 10, room2);
        const booking3 = new Booking("booking3", "bok@bok.es", "2023-10-01", "2023-10-06", 10, room2);
        const booking4 = new Booking("booking4", "bok2@bok.es", "2023-10-07", "2023-10-15", 10, room1);
    ...
    test('availableRooms tiene que devolver dos rooms', () => {
        ...
        const room2 = new Room('room2', [], 150, 10);
        const booking1 = new Booking("booking1", "bok@bok.es", "2023-10-16", "2023-10-31", 10, room1);
        const booking2 = new Booking("booking2", "bok2@bok.es", "2023-11-07", "2023-11-15", 10, room2);
        const booking3 = new Booking("booking3", "bok@bok.es", "2023-11-01", "2023-11-06", 10, room2);
        const booking4 = new Booking("booking4", "bok2@bok.es", "2023-10-07", "2023-10-15", 10, room1);
        const bookingsB = [booking3, booking2];
        const bookingsA = [booking1, booking4];
        const room_1 = new Room(room1.name, bookingsA, room1.rate, room1.discount);
...
describe('Bookings tests', () => {
    test('fee test debe devolver un precio distinto al inicial', () => {
        ...
        const booking = new Booking("booking1", "bok@bok.es", "2023-10-16", "2023-10-31", 10, room);
    ...
    test('fee test debe devolver el precio inicial al no tener ningún descuento', () => {
        ...
        const booking = new Booking("booking1", "bok@bok.es", "2023-10-16", "2023-10-31", 0, room);
        const fee = booking.getFee();
        expect(fee).toBe(150);
    });
    ...
    test('fee test debe devolver el precio solo con el descuento de la booking', () => {
        const room = new Room('room2', [], 150, 0);
        const booking = new Booking("booking1", "bok@bok.es", "2023-10-16", "2023-10-31", 50, room);
        const fee = booking.getFee();
        expect(fee).toBe(75);
    });
